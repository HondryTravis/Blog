...
使用 [打包分析](/blog/optimization/webpack_until_v4.md#打包分析) 得出结果，

对 loader 慢处理 [缓存加速](/blog/optimization/webpack_until_v4.md#缓存加速)

对静态代码处理 [代码分析](/blog/optimization/webpack_until_v4.md#代码分析)

多线程加速压缩 [多核优化](/blog/optimization/webpack_until_v4.md#多核优化压缩)

对 html 处理 [html](/blog/optimization/webpack_until_v4.md#html)

对图片处理 [image](/blog/optimization/webpack_until_v4.md#图片)
